        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div><a href="products_writeform.php?Bdiv=2&Mdiv=1">상품등록</a></div>
                    <div class="row">
                        <div class="col-xl-5 col-md-5">
                            <div class="card mb-4">
                                <div class="card-header"><i class="fas fa-list mr-1"></i>상품관리</div>
                                <div class="card-body">
                                <?php
                                ...
                                <?php
                                        ...
                                        while ($row=mysqli_fetch_array($results)) {
                                            ...
                                            <tr data-index="<?= $rs_idx ?>" data-position="<?= $rs_position ?>" class="d-flex pointer table-info">
                                                ...
                                                <td class="text-align-right ml-auto">
                                                    <div class="btn-group">
                                                        <button id="btnGroupDrop1-<?= $rs_idx; ?>" type="button" class="btn btn-info btn-xs dropdown-toggle" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-edit mr-1"></i>EDIT</button>
                                                        <ul class="dropdown-menu dropdown-menu-lg-right dropdown-menu-samll" aria-labelledby="btnGroupDrop1-<?= $rs_idx; ?>">
                                                            ...
                                                            <li><a class="dropdown-item small" href="#"><i class="fa fa-eye-slash mr-1"></i>비활성</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="col-xl-7 col-md-7">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <script src="category1_writeok.js" crossorigin="anonymous"></script>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="DeleteCate1Label">카테고리 삭제</h6>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                <form name="category1_editform" id="category1_editform" class="needs-validation" method="post" action="category1_editok.php" novalidate>
                    <div class="modal-header">
                        <h6 class="modal-title" id="UpdateCate1Label">카테고리 수정</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
